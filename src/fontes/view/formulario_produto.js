                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        <Row className="mb-3">
                            ...
                            <Form.Group as={Col} md="4" controlId="validationCustom02">
                                ...
                                {loading ? (
                                  <>
                                    <PlaceholderComp tag="p" bg="secondary" animation="wave" size="12" estilo={StyleCampoMd4}/>
                                   </>
                                  )
                                   :(
                                        <Form.Floating className="mb-3">
                        ...
                        <Row>
                            ...
                            {loading ? (
                                  <>
                                    <PlaceholderComp tag="p" bg="secondary" animation="wave" size="12" estilo={StyleCampoMdGeral}/>
                                   </>
                            ) : (<>
